<!DOCTYPE html>
        ...
        <meta charset="UTF-8">
        <title>Data Update Search</title>
        ...
        <div class="main">
            ...
            <div class="content">
                <form method="POST">
                    <input class ="input" type="text" name="updatesearchName" placeholder="Age only" required/>
                    <input type="submit" class="button" name="updatesearchEnter" value="enter"/>
                </form>
            </div>
            <div class="footer">
